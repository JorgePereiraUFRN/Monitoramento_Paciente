...
public class Medico extends javax.swing.JFrame implements GUI {
	...
	public void atualizarGUI(String paciente) {
		...
		DefaultTableModel model = (DefaultTableModel) jTalertas.getModel();
	...
	private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {   
		if(jTalertas.getSelectedRow() > -1){
        String nomePaciente = (String) jTalertas.getModel().getValueAt(jTalertas.getSelectedRow() , 0);
       
        new Historico(nomePaciente).setVisible(true);
		}else{
	...
	private void initComponents() {
		...
		jTalertas.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] {  },
				new String[] { "Paciente", "Alertas" }));
		jTalertas.setAutoscrolls(false);
		jTalertas.setComponentPopupMenu(jPopupMenu);
		jScrollPane1.setViewportView(jTalertas);
		...
		jTalertas.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
